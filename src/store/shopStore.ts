...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'skin-autumn-forest-bookshop-v1', category: 'skin', name: '가을 숲속 서점', priceType: 'points', price: 150, emoji: '🍂', colorHex: '#8B4A2F' },
  { id: 'skin-ocean-glasshouse-library-v1', category: 'skin', name: '여름 바다 유리온실', priceType: 'points', price: 200, emoji: '🐚', colorHex: '#55BFC4' },
  { id: 'skin-snowy-reading-cabin-v1', category: 'skin', name: '설산 독서 오두막', priceType: 'points', price: 220, emoji: '❄️', colorHex: '#8EA9BA' },
  { id: 'skin-hanok-dawn-study-v1', category: 'skin', name: '한옥 새벽 서재', priceType: 'points', price: 240, emoji: '🏡', colorHex: '#769688' },
  { id: 'skin-neon-study-arcade-v1', category: 'skin', name: '네온 스터디 아케이드', priceType: 'points', price: 300, emoji: '🕹️', colorHex: '#8C55DD' },
  { id: 'skin-celestial-observatory-academy-v1', category: 'skin', name: '별빛 천문 마법학교', priceType: 'points', price: 320, emoji: '🔭', colorHex: '#292958' },
